...
INSERT INTO actividades (
    ...
    ('Free Tour por San Telmo', 'https://picsum.photos/seed/santelmo/600/400',
     1, 6, 120, 0.00, 25, '2026-01-01', '2026-12-31',
     ...
     'Plaza de Mayo, frente al Cabildo', -34.6083, -58.3712,
     'Martin Gonzalez', 'Espanol', 'Cancelacion gratuita hasta 24hs antes.'),

    ('Tour Gastronomico en Palermo', 'https://picsum.photos/seed/palermo/600/400',
     1, 3, 180, 18500.00, 12, '2026-01-01', '2026-12-31',
     ...
     'Plaza Serrano, Palermo Soho', -34.5882, -58.4350,
     'Lucia Fernandez', 'Espanol/Ingles', 'Cancelacion 50% hasta 48hs antes.'),

    ('Trekking Cerro Catedral', 'https://picsum.photos/seed/catedral/600/400',
     2, 1, 480, 32000.00, 8, '2026-03-01', '2026-11-30',
     ...
     'Centro Civico de Bariloche', -41.1335, -71.3103,
     'Pedro Rios', 'Espanol', 'Cancelacion gratuita hasta 72hs antes por clima.'),

    ('Visita guiada Bodega Catena Zapata', 'https://picsum.photos/seed/bodega/600/400',
     3, 7, 150, 22000.00, 20, '2026-01-01', '2026-12-31',
    ...
    ('Avistaje de ballenas Puerto Madryn', 'https://picsum.photos/seed/ballenas/600/400',
     1, 4, 240, 38000.00, 18, '2026-06-01', '2026-12-15',
     'Excursion en barco para avistar ballenas francas australes.',
     'Embarcacion, chaleco, guia naturalista, hidratacion.',
     'Puerto Piramides', -42.5750, -64.2778,
     'Lucas Fernandez', 'Espanol/Ingles', 'Cancelacion gratuita por clima.'),

    ('Free Tour Recoleta', 'https://picsum.photos/seed/recoleta/600/400',
     1, 6, 90, 0.00, 30, '2026-01-01', '2026-12-31',
     'Recorrido por el cementerio de la Recoleta y los principales puntos del barrio.',
     'Guia profesional. A la gorra.',
     'Entrada del cementerio', -34.5875, -58.3927,
    ...
    ('City tour panoramico Buenos Aires', 'https://picsum.photos/seed/citytour/600/400',
     1, 7, 180, 15000.00, 40, '2026-01-01', '2026-12-31',
     'Recorrido por los barrios mas emblematicos: Plaza de Mayo, La Boca, San Telmo, Recoleta y Palermo.',
     'Bus turistico, guia bilingue.',
     'Obelisco, Av. 9 de Julio', -34.6037, -58.3816,
...
-- Ana califica su reserva FINALIZADA
-- =========================================
INSERT INTO calificaciones (reserva_id, rating_actividad, rating_guia, comentario, creada_en)
